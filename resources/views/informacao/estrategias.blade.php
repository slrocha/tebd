...
<form class="form-horizontal" method="#">
 <div class="container">
  <div class="jumbotron">
    <h2>Estratégias Utilizadas para Concepção do Projeto</h2> </br>
  </div>
  ...
  <div class="well">
  	...
  	<p align="justify">como usar
	configuração do ambiente
	instalação do apache, mysqlserver, php, composer, e o laravel precisamente</p>
  </div>
</div>
</form>
@stop('content')
